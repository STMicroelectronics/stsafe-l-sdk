 ...
 *          - Uses ST production CA certificate (SPL02)
...
int main(void) {
    ...
    printf("----------------------------------------------------------------------------------------------------------------");
    printf("\n\r-                          STSAFE-L010 SPL02 Device Authentication Example                                     -");
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    ...
    if (stse_ret != STSE_OK) {
        printf("\n\n\r ## Device authentication over STSAFE-L010 SPL02 CA certificate :"PRINT_RED" FAIL "PRINT_RESET"\n\r");
        printf("\n\r\t o stse_device_authenticate"PRINT_RED": ERROR 0x%04X"PRINT_RESET, stse_ret);
        apps_process_error(stse_ret);
    } else {
        printf("\n\n\r ## Device authentication over STSAFE-L010 SPL02 CA certificate :"PRINT_GREEN" SUCCESS "PRINT_RESET"\n\r");
    }
